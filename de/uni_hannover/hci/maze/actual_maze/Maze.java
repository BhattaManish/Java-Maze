    ...
    */
    public Maze(int width, int height, int algorithm){
        ...
        if(algorithm == 1){
            ...
            System.out.println("Doing the Deep Search Algoritthm\n");
        	strMaze = AlgorithmSelector.getMazeFromAlgorithm(Algorithm.DEEP_SEARCH, width, height);
            System.out.println("Deep search  alg. selected");
        }
